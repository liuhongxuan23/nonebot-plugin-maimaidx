...
best50  = on_command('b50', aliases={'B50'}, priority=5, permission=perm_maimai)
minfo   = on_command('minfo', aliases={'minfo', 'Minfo', 'MINFO', 'info', 'Info', 'INFO'}, priority=5, permission=perm_maimai)
ginfo   = on_command('ginfo', aliases={'ginfo', 'Ginfo', 'GINFO'}, priority=5, permission=perm_maimai)
score   = on_command('分数线', priority=5, permission=perm_maimai)
